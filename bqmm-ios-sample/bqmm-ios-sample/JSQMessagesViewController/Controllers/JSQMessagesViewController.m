...
- (void)jsq_configureMessagesViewController
{
    ...
    self.inputToolbar.contentView.textView.textColor = [UIColor redColor];
    self.inputToolbar.contentView.textView.textStorage.delegate = self;
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!isMediaMessage) {
        MMMessage *mmMessage = (MMMessage*)messageItem;
        if ([mmMessage.extra[@"txt_msgType"] isEqualToString:@"emojiType"]) {
            [cell.textView setMmTextData:mmMessage.extra[@"msg_data"]];
        }
        else {
            cell.textView.mmText = mmMessage.text;
        }
...
//        }
        ...
        cell.messageBubbleImageView.animationDuration = 1.0/60.0;
